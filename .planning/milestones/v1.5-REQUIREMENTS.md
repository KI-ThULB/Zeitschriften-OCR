# Requirements Archive: v1.5 Web Viewer Complete
...
- [x] **STRUCT-01**: User can trigger automatic article segmentation for any page via a configurable VLM/LLM provider (provider and model set via config file or `--vlm-provider` / `--vlm-model` CLI flags)
...
- [x] **STRUCT-03**: Each identified article gets a title and section type extracted and made accessible as structured metadata
...
| STRUCT-01 | Phase 15+17 | Complete |
| STRUCT-02 | Phase 15 | Complete |
| STRUCT-03 | Phase 15+18 | Complete |
...
*Last updated: 2026-03-02 after v1.5 completion — all 17 requirements complete*
